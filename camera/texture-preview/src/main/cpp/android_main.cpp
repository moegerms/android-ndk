 ...
 *
 */
int Engine::GetCameraSensorOrientation(int32_t requestFacing) {
...
Java_com_sample_textureview_ViewActivity_GetCameraSensorOrientation(JNIEnv *env, jobject instance) {
